/obj/machinery/factory
	...
	icon = 'proxima/icons/obj/factory/factory.dmi'
...
/obj/machinery/factory/proc/set_input(var/_dir)
	input_dir = _dir ? get_step(loc, _dir) : null

/obj/machinery/factory/proc/set_output(var/_dir)
	output_dir = _dir ? get_step(loc, _dir) : null
...
/obj/item/stock_parts/circuitboard/factory
	...
	board_type = "machine"
	origin_tech = list(TECH_ENGINEERING = 2, TECH_POWER = 1, TECH_DATA = 1, TECH_MATERIAL = 2)
	req_components = list(
