...
/datum/gear/head/armyberet/New()
	...
	berets["interstellar beret"] = /obj/item/clothing/head/beret/solgov/army/infantry // old infantry beret
	berets["orbital assaul interstellar beret"] = /obj/item/clothing/head/beret/solgov/army/orbital
	berets["logistical supply interstellar beret"] = /obj/item/clothing/head/beret/solgov/army/logistical_supply
	berets["engineering-sapper interstellar beret"] = /obj/item/clothing/head/beret/solgov/army/engisapper
	berets["command interstellar beret"] = /obj/item/clothing/head/beret/solgov/army/command
	berets["medical interstellar beret"] = /obj/item/clothing/head/beret/solgov/army/medical
	gear_tweaks += new/datum/gear_tweak/path(berets)
